...
constexpr std::uint32_t k_pseudocode_renderer_schema_version = 1;

enum class pseudocode_renderer_style_profile_t : std::uint8_t {
    compact = 1,
    balanced = 2,
    audit = 3
};

struct pseudocode_renderer_limits_t {
...
decompiler_renderer_settings_t pseudocode_renderer_style_settings(
    pseudocode_renderer_style_profile_t profile);

...
const std::vector<testlab_entry_t>& testlab_entries() {
    static const std::vector<testlab_entry_t> entries = {
        ...
        external_entry("workbench_shell", "workbench_documents_harness.cpp", "aida_c03_c20_c22_workbench_documents_harness", testlab_category_t::workbench),
        ...
        external_entry("live_routing", "live_routing_integration_harness.cpp", "aida_c03_c19_live_routing_integration_harness", testlab_category_t::live_routing),
        in_process_entry("analysis_handlers", "analysis_handlers_harness.cpp", testlab_category_t::contract, 84),
        in_process_entry("composite_handlers", "composite_handlers_harness.cpp", testlab_category_t::contract, 4),
        in_process_entry("core_handlers", "core_handlers_harness.cpp", testlab_category_t::contract, 75),

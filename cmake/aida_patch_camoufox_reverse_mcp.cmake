if(NOT DEFINED AIDA_CAMOUFOX_STAGE_ROOT)
    message(WARNING "AIDA_CAMOUFOX_STAGE_ROOT is required")
endif()
...
if(AIDA_CAMOUFOX_REPO_MULTIPAGE_SOURCE_READY)
    ...
    if(NOT EXISTS "${AIDA_CAMOUFOX_MULTIPAGE_PATCHER}")
        message(WARNING "Missing Camoufox multipage patcher: ${AIDA_CAMOUFOX_MULTIPAGE_PATCHER}")
    endif()
    if(NOT AIDA_CAMOUFOX_PATCH_PYTHON)
        message(WARNING "Python interpreter required for Camoufox multipage patcher")
    endif()
    execute_process(
    ...
    if(NOT AIDA_CAMOUFOX_MULTIPAGE_PATCH_RESULT EQUAL 0)
        message(WARNING "Camoufox multipage patch failed: ${AIDA_CAMOUFOX_MULTIPAGE_PATCH_OUT} ${AIDA_CAMOUFOX_MULTIPAGE_PATCH_ERR}")
    endif()
